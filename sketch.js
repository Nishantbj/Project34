...
function draw() {
  ...
  background("white");
  image(bg,width/2,height/2,1200,700)
  push()
  fill("white")
  ground.show()
  pop()
  ...
  stroke(3);
  fill("black");
  text("Demolishing Buildings !! ", width / 2, height - 660)

  textSize(30);
  stroke(4);
  fill("black");
  text("CLICK ON SPACEBAR TO MOVE THE BALL !! ", 490, height - 600)
